# anonjs
Dead simple and easy to use JavaScript based Anon library. Inspired by [pybitcointools](https://github.com/vbuterin/pybitcointools)
...
# Example usage
```javascript
var anonjs = require('anonjs')

var priv = anonjs.utils.makePrivKey('chris p. bacon, defender of the guardians')
// 2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c

var privWIF = anonjs.utils.privKeyToWIF(priv)
// 5J9mKPd531Tk4A73kKp4iowoi6EvhEp8QSMAVzrZhuzZkdpYbK8

var pubKey = anonjs.utils.privKeyToPubKey(priv)
...
var zAddr = anonjs.utils.pubKeyToAddr(pubKey)
// t1aYp69J595Rhaof2AEFuEvJjLWVboddB2x

// To create and sign a raw transaction
var txobj = anonjs.transaction.createRawTx([{txid: '196173ec34d22a52cc689a21d01dd33b633671cbe1141e7e66240c7f3b4ccf7b', vout: 0}], [{address: 't1aYp69J595Rhaof2AEFuEvJjLWVboddB2x', satoshis: 100000}])
// anonjs.transaction.serializeTx(txobj)
...
var tx0 = anonjs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c')
// anonjs.transaction.serializeTx(tx0)
...
// You can now do anon-cli sendrawtransaction `SERIALIZED_TRANSACTION`
```